...
import com.dialog.dialoggo.networking.retrofit.ApiInterface;
import com.dialog.dialoggo.networking.retrofit.RequestConfig;
...
public class LoginRepository {
    ...
    public LiveData<com.dialog.dialoggo.activities.SelectAccount.SelectAccountModel.Response> getConnectionDetails(String phoneNumber) {
        MutableLiveData<com.dialog.dialoggo.activities.SelectAccount.SelectAccountModel.Response> mutableLiveData = new MutableLiveData<>();
       ...
       // jsonObject.addProperty("status", "C");
        ...
        Call<com.dialog.dialoggo.activities.SelectAccount.SelectAccountModel.Response> call = endpoint.getConnectionDetails(jsonObject);
