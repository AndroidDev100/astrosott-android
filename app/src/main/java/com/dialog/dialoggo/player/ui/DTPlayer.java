...
import com.dialog.dialoggo.adapter.CatchupTvAdapter;
...
import com.dialog.dialoggo.databinding.FragmentDtplayerBinding;
import com.dialog.dialoggo.fragments.dialog.AlertDialogFragment;
import com.dialog.dialoggo.fragments.dialog.AlertDialogNetworkFragment;
...
import com.dialog.dialoggo.player.viewModel.DTPlayerViewModel;
...
import com.dialog.dialoggo.utils.helpers.Network;
import com.dialog.dialoggo.utils.helpers.NetworkChangeReceiver;
import com.dialog.dialoggo.utils.helpers.NetworkConnectivity;
import com.dialog.dialoggo.utils.helpers.PhoneStateListenerHelper;
import com.dialog.dialoggo.utils.helpers.PrintLogging;
import com.dialog.dialoggo.utils.helpers.SwipeGestureListener;
...
import static com.dialog.dialoggo.fragments.nowPlaying.NowPlaying.EXTERNAL_IDS;
...
//                        ProgramAsset programAsset = (ProgramAsset) asset;
                        ...
                        Log.d("externalIDIs", EXTERNAL_IDS);
...
//                                    playerChecksCompleted = true;
    ...
    private void getCurrentProgramTimeStamp() {
        viewModel.liveCatchupData(EXTERNAL_IDS).observe(this, railCommonData -> {
...
//        }
    ...
    private void loadPreviousCatchup(Long startTime, Asset object) {
        viewModel.loadCatchupData(EXTERNAL_IDS, String.valueOf(startTime), 1).observe(this, railCommonData -> {
            if (railCommonData != null && railCommonData.size() > 0) {
                try {
    ...
    private void loadNextCatchup(Long startTime, List<RailCommonData> railCommonDataPrevious) {
        viewModel.loadCatchupData(EXTERNAL_IDS, String.valueOf(startTime), 2).observe(this, railCommonData -> {
            if (railCommonData != null && railCommonData.size() > 0) {
                try {
            ...
            /*try {
                if (trackName.equals("")) {
                    ...
                    selectedIndex = position;*//*
                        //   tracks.get(position).setSelected(true);
