package com.dialog.dialoggo.fragments.schedule.ui;
...
import com.dialog.dialoggo.databinding.FragmentScheduleBinding;
import com.dialog.dialoggo.fragments.dialog.AlertDialogSingleButtonFragment;
import com.dialog.dialoggo.fragments.schedule.adapter.ProgramsAdapter;
...
import com.dialog.dialoggo.utils.helpers.RecyclerAnimator;
...
//            new Handler().postDelayed(this::getEPGChannels, 500);
    ...
    private void getEPGChannels() {
        ...
        viewModel.getEPGChannelsList(EXTERNAL_IDS, startTimeStamp, endTimeStamp, 2, counter).observe(this, railCommonData -> {
