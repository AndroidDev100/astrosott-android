...
import com.dialog.dialoggo.databinding.SquareListingItemBinding;
...
public class SquareListingAdapter extends RecyclerView.Adapter<SquareListingAdapter.SingleItemRowHolder> {
    ...
    public SquareListingAdapter(Activity context, List<RailCommonData> itemsList, int type) {
    ...
    @NonNull
    @Override
    public SquareListingAdapter.SingleItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SquareListingAdapter.SingleItemRowHolder holder, int i) {
