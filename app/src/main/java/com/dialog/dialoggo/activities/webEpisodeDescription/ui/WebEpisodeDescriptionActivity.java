...
import com.dialog.dialoggo.databinding.ActivityWebEpisodeDescriptionBinding;
import com.dialog.dialoggo.fragments.dialog.AlertDialogSingleButtonFragment;
import com.dialog.dialoggo.fragments.dialog.PlaylistDialogFragment;
...
import com.dialog.dialoggo.utils.helpers.CommonPlaylistDialog;
...
//                        break;
    ...
    private void checkEntitleMent(final RailCommonData railCommonData) {
        ...
        runOnUiThread(new Runnable() {
            ...
            AssetContent.getVideoResolution(asset.getTags()).observe(WebEpisodeDescriptionActivity.this, new Observer<String>() {
            @Override
