...
public class MaximumLimitDialog extends DialogFragment {
    ...
    public MaximumLimitDialog() {
        // Empty constructor is required for DialogFragment
        // Make sure not to add arguments to the constructor
        // Use `newInstance`method
    }

    public static MaximumLimitDialog newInstance(String title, String message) {
        MaximumLimitDialog frag = new MaximumLimitDialog();
...
//        return inflater.inflate(R.layout.edit_dialog_layout, container);
        ...
        View view = inflater.inflate(R.layout.maximum_limit_dialog_fragment, container);
