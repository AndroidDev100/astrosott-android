...
import com.astro.sott.activities.moreListing.viewModel.DetailListingViewModel;
import com.astro.sott.adapter.LandscapeDetailListingAdapter;
...
public class DetailListingActivity extends BaseBindingActivity<ListingActivityBinding> implements DetailRailClick {
    ...
    private LandscapeDetailListingAdapter commonLandscapeListingAdapter;
    ...
    private void modelCall() {
        viewModel = ViewModelProviders.of(this).get(DetailListingViewModel.class);
    ...
    private void setUIComponets(List<RailCommonData> railList) {
      /* for (int i=0;i<railList.size();i++){
        ...
        if (layout.equalsIgnoreCase(AppLevelConstants.TYPE3) || layout.equalsIgnoreCase(AppLevelConstants.TYPE6)) {
            commonPotraitListingAdapter = new PotraitDetailListingAdapter(this, list, layoutType);
            ...
            commonSquareListingAdapter = new SquareDetailListingAdapter(this, railList, layoutType);
            getBinding().listRecyclerview.setAdapter(commonSquareListingAdapter);
        } else if (layout.equalsIgnoreCase(AppLevelConstants.TYPE5)) {
            commonLandscapeListingAdapter = new LandscapeDetailListingAdapter(this, railList, layoutType);
    ...
    private void setRecyclerProperty() {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(DetailListingActivity.this, spanCount);
