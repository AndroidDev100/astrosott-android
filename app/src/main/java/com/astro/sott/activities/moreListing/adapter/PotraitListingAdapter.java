...
//                singleItem.getType();
                ...
                ImageHelper.getInstance(holder.potraitItemBinding.itemImage.getContext()).loadImageToPortraitListing(holder.potraitItemBinding.itemImage, assetCommonImages.getImageUrl(), R.drawable.ic_potrait_placeholder);

            } else {
                ImageHelper.getInstance(holder.potraitItemBinding.itemImage.getContext()).loadImageToPlaceholder(holder.potraitItemBinding.itemImage, AppCommonMethods.getImageURI(R.drawable.ic_potrait_placeholder, holder.potraitItemBinding.itemImage), R.drawable.ic_potrait_placeholder);
