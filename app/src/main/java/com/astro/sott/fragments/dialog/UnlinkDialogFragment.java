...
public class UnlinkDialogFragment extends DialogFragment {
    private EditDialogListener editDialogListener;
    private EditText etDialog;
    private TextInputLayout inputLayoutDialog;
    private String fileId = "";
    private String strMessage = "";
    private String title_value = "", message = "", actnBtn = "", negative_actn_btn;
    private BaseActivity baseActivity;

    public UnlinkDialogFragment() {
        // Empty constructor is required for DialogFragment
        // Make sure not to add arguments to the constructor
        // Use `newInstance`method
    }

    public static UnlinkDialogFragment newInstance(String title, String message, String actnBtn, String negativeActnBtn) {
        UnlinkDialogFragment frag = new UnlinkDialogFragment();
        ...
        args.putString(AppLevelConstants.NEGATIVE_ACTION_BTN, negativeActnBtn);
...
//        return inflater.inflate(R.layout.edit_dialog_layout, container);
        ...
        View view = inflater.inflate(R.layout.unlink_dialog_item, container);
        if (getDialog().getWindow() != null) {
            ...
            negative_actn_btn = getArguments().getString(AppLevelConstants.NEGATIVE_ACTION_BTN);
            ...
            btnCancel.setText(negative_actn_btn);

//
            btnOk.setOnClickListener(v -> {
                editDialogListener.unlinkBtnClicked();
                dismiss();
            });
